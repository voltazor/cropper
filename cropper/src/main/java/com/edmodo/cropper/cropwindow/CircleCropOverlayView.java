...
/**
 * A custom View representing the circle crop window and the shaded background outside
 * the crop window.
 */
...
//                mBorderPaint);
        canvas.drawCircle(mCircleRect.centerX(), mCircleRect.centerY(), mCircleRect.width() / 2, mBorderPaint);
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (bitmapRect.left != 0 || bitmapRect.top != 0 || bitmapRect.right != 0 || bitmapRect.bottom != 0) {
        ...
        resetCircleRectAndPath();
    }

    private void resetCircleRectAndPath() {
        mCircleRect.set(Edge.LEFT.getCoordinate(), Edge.TOP.getCoordinate(), Edge.RIGHT.getCoordinate(), Edge.BOTTOM.getCoordinate());
        mCirclePath.reset();
        mCirclePath.addCircle(mCircleRect.centerX(), mCircleRect.centerY(), mCircleRect.width() / 2, Path.Direction.CW);
    }
